...
public class FSM_FarmerRecolection : FiniteStateMachine
{
    ...
    public override void OnConstruction()
    {
        ...
        State REACH_HOME = new State("REACH_HOME",
           ...
           () => { }, // write in state logic inside {}
           () => { arrive.enabled = false; thePotato.transform.parent = null; thePotato.tag = "NOPOTATO"; powerUpSpawner.potatoRecolectedCounter++; Score.potatoScoreValue++; Score.potatoRecolectedInScene++; }  // write on exit logic inisde {}  
       );
